    ...
    <div class="card">
        <div class="justify-content-between d-flex align-items-center">
            <h5 class="card-header">
                <i class="menu-icon tf-icons ri-alarm-warning-line me-2"></i>Edit Data Laporan Kerusakan
            </h5>
            <div class="pe-5">
        ...
        <div class="card-body pt-6">
            ...
            <form class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <textarea name="pesan_kerusakan" class="form-control" rows="5" placeholder="Masukkan Pesan, Waktu dan Tempat dengan detail" required><?= isset($_POST['pesan_kerusakan']) ? htmlspecialchars($_POST['pesan_kerusakan']) : htmlspecialchars($row['pesan_kerusakan']) ?></textarea>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="file" name="bukti_kerusakan" class="form-control" accept="image/*">
                        <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['bukti_kerusakan']['name'])) {
        ...
        $bukti_kerusakan = $file_lama; // Gunakan file KTP yang sudah ada
    }

    $update = $con->query("UPDATE kerusakan SET
        pesan_kerusakan = '$pesan_kerusakan',
        id_gardu = '$id_gardu',
        bukti_kerusakan = '$bukti_kerusakan',
