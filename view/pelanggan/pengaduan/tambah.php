    ...
    <div class="card">
        <div class="justify-content-between d-flex align-items-center">
            <h5 class="card-header">
                <i class="menu-icon tf-icons ri-chat-follow-up-line me-2"></i>Tambah Data Pengaduan
            </h5>
            <div class="pe-5">
        ...
        <div class="card-body pt-6">
            ...
            <form class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <textarea name="pesan_pengaduan" class="form-control" rows="5" placeholder="Masukkan Pesan, Waktu dan Tempat dengan detail" required><?= isset($_POST['pesan_pengaduan']) ? htmlspecialchars($_POST['pesan_pengaduan']) : form_value('pesan_pengaduan') ?></textarea>
                ...
                <div class="row mb-4">
                    <label class="col-sm-2 col-form-label">Upload Bukti Pengaduan</label>
                    <div class="col-sm-10">
                        <input type="file" name="bukti_pengaduan" class="form-control" accept="image/*" required>
                        <div class="invalid-feedback">Kolom tidak boleh kosong !</div>
