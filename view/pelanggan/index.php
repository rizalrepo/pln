...
$d = $con->query("SELECT COUNT(*) AS total FROM kerusakan WHERE id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
$d1 = $con->query("SELECT COUNT(*) AS total FROM kerusakan WHERE verif = 0 AND id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
$d2 = $con->query("SELECT COUNT(*) AS total FROM kerusakan WHERE verif = 2 AND id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
$d3 = $con->query("SELECT COUNT(*) AS total FROM kerusakan WHERE verif = 1 AND id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                        ...
                        <div class="content-right">
                            ...
                            <span class="mx-2"> | </span>
                            <span class="text-warning mb-0 h6"><?= $d1['total'] ?> Data Menunggu Verifikasi</span>
                            <span class="mx-2"> | </span>
                            <span class="text-danger mb-0 h6"><?= $d2['total'] ?> Data Ditolak</span>
                            <span class="mx-2"> | </span>
                            <span class="text-success mb-0 h6"><?= $d3['total'] ?> Data Disetujui</span>
                        </div>
                    </div>
                </div>
            </div>
