...
$b = $con->query("SELECT COUNT(*) AS total FROM pengaduan WHERE id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
$b1 = $con->query("SELECT COUNT(*) AS total FROM pengaduan WHERE status_pengaduan = 0 AND id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
$b2 = $con->query("SELECT COUNT(*) AS total FROM pengaduan WHERE status_pengaduan = 1 AND id_pelanggan = '$_SESSION[id_pelanggan]' ")->fetch_array();
?>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center gap-4 me-6 me-sm-0">
                        ...
                        <div class="content-right">
                            ...
                            <span class="mx-2"> | </span>
                            <span class="text-warning mb-0 h6"><?= $b1['total'] ?> Data Belum Ditanggapi</span>
                            <span class="mx-2"> | </span>
                            <span class="text-success mb-0 h6"><?= $b2['total'] ?> Data Ditanggapi</span>
                        </div>
                    </div>
                </div>
            </div>
