    ...
    <div class="card">
        <div class="justify-content-between d-flex align-items-center">
            <h5 class="card-header">
                <i class="menu-icon tf-icons ri-building-line me-2"></i>Tambah Data Gardu
            </h5>
            <div class="pe-5">
        ...
        <div class="card-body pt-6">
            ...
            <form class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nm_gardu" class="form-control" required>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO gardu VALUES (
        default,
        '$nm_gardu', 
        '$area'
    )");
